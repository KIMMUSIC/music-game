...
- **실시간 채팅**: 게임 중 채팅으로 소통
- **점수 시스템**: 가장 먼저 정답을 맞춘 플레이어가 1점 획득
...
2. **가장 먼저 정답을 맞춘 플레이어가 1점 획득**
3. 틀려도 시간 내에 계속 재시도 가능
4. 힌트가 활성화된 퀴즈의 경우 5초 후 힌트 확인 가능
5. 모든 라운드 종료 후 최종 순위 확인

### 점수 규칙

- 라운드당 **가장 먼저 정답을 맞춘 1명만** 점수 획득
- 정답 시 **1점** 획득
- 오답 시 페널티 없이 계속 시도 가능
- 최종 순위는 총 획득 점수로 결정
...
```bash
# 저장소 클론
git clone https://github.com/KIMMUSIC/music-game.git
cd music-quiz-game
